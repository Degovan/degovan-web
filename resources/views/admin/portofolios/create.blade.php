...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Halaman Tambah Portofolio</li>
        </ol>
    </nav>
    ...
    <div class="row justify-content-center">
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Tambah Portofolio</h1>
                <p class="mb-0">Form untuk menambahkan kategori portofolio.</p>
            </div>
        </div>
        <div class="card border-light shadow-sm components-section">
            <div class="card-body">
                <form action="{{ route('portofolios.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
