                    ...
                    <div class="row mb-4">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Judul Artikel" autocomplete="off" id="title" name="title" value="{{ old('title') ? old('title') : $post->title }}">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category_post_id" class="form-control" id="category_post_id">
                                    @foreach ($post_categories as $post_category)
                                        ...
                                        @else
                                            {{ $post->category_post_id == $post_category->id ? 'selected' : '' }}
                                        @endif    
                                ...
                                <select name="tags[]" multiple="multiple" class="w-100 js-example-basic-multiple" id="tags">
                                    @foreach ($tags as $tag)
                                        ...
                                        @foreach ($post_tags as $post_tag)
                                            {{ $tag->id == $post_tag->tag_id ? 'selected' : '' }}
                                        @endforeach    
                                        >{{ $tag->name }}</option>
                                    @endforeach
                                </select>
