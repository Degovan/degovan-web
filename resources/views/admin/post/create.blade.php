            ...
            <div class="card-body">
                <form action="{{ route('admin.post.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    placeholder="Judul Artikel" autocomplete="off" id="title" name="title"
                                    value="{{ old('title') }}">
                                @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control-file" name="image" id="gambar" placeholder=""
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category_post_id" class="form-control" id="category_post_id">
                            ...
                            <option value="{{ $post_category->id }}"
                                {{ old('category_post_id') == $post_category->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tags[]" multiple="multiple" class="w-100 js-example-basic-multiple" id="tags">
                            @foreach ($tags as $tag)
                            <option value="{{ $tag->id }}" @if (old('tags')) @foreach (old('tags') as $old_tag)
                                {{ $tag->id == $old_tag ? 'selected' : '' }} @endforeach @endif>{{ $tag->name }}
                            </option>
                            @endforeach
                        </select>
                        @error('tag')
                    ...
                    <div class="col-">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Nama Tag" autocomplete="off" id="name" name="name"
                                value="{{ old('name') }}">
                            @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
