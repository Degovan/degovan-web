...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Tag Artikel</li>
        </ol>
    </nav>
</div>
                    ...
                    <div class="row mb-4">
                        <div class="col-">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Tag Artikel" autocomplete="off" id="name" name="name" value="{{ old('name') ? old('name') : $tag->name }}">
                                @error('name')
